...
public class InterestController {
    ...
    public List<InterestEntity> getPublicInterestList(@RequestParam(value = "title", required = false) String title) {
        return interestService.getInsterest(title);
    }

    @GetMapping("/public/interests/interest")
    public InterestEntity getInterestById(@RequestParam(value = "id") int id) {
    ...
    public InterestEntity insertInterest(@RequestBody InterestEntity interestEntity) {
    ...
    public InterestEntity updateInterest(@RequestBody InterestEntity interestEntity) {
    ...
    public PageResult getAdminInterestList(@RequestParam("pageSize") int pageSize, @RequestParam("page") int page) {
    ...
    public List<String> setBanners(@RequestBody List<String> groupId) {
        interestService.updateBanners(groupId, 1);
        return groupId;
    }

    @PutMapping("/admin/banners/del")
    public List<String> delBanners(@RequestBody List<String> groupId) {
